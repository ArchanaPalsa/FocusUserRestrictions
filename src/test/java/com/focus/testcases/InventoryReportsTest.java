...
public class InventoryReportsTest extends BaseEngine
{
	static InventoryReportsPage IRP;
	 ...
	 @Test(priority=441)
	 public void checkRaiseIndentItemwithLowStockReport() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 IRP=new InventoryReportsPage(getDriver());
		 Assert.assertEquals(IRP.checkRaiseIndentItemwithLowStockReport(), true);
	 }
	 
	 
	 @Test(priority=442)
	 public void checkRaiseRequestForQuoteReport() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 IRP=new InventoryReportsPage(getDriver());
		 Assert.assertEquals(IRP.checkRaiseRequestForQuoteReport(), true);
	 }
	 ...
	 {
		 IRP=new InventoryReportsPage(getDriver());
		 Assert.assertEquals(IRP.checkGeneralLedgerandInventoryMismatchReport(), true);
	 }
	 
	
	 @Test(priority=444)
	 public void checkNegativeBatchListReport() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 IRP=new InventoryReportsPage(getDriver());
		 Assert.assertEquals(IRP.checkNegativeBatchListReport(), true);
	 }
